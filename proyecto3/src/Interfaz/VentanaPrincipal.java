...
public class VentanaPrincipal extends JFrame implements ListSelectionListener {
	...
	private JPanel getSubPanelBotonCategoria()
	{
		...
		icon = new ImageIcon("src"+slash+"images"+slash+"home_cat.png");
		homeCat.setIcon(icon);
		
		icon = new ImageIcon("src"+slash+"images"+slash+"back_cat.png");
		retCat.setIcon(icon);
	...
	private JButton getBoton(String str)
	{
		...
		if (str.equals("Ayuda"))
			icon = new ImageIcon("src"+slash+"images"+slash+"help.png");
		else if (str.equals("Perfil"))
			icon = new ImageIcon("src"+slash+"images"+slash+"profile.png");
		else if (str.equals("Cesta"))
			icon = new ImageIcon("src"+slash+"images"+slash+"cart.png");
		else
			icon = new ImageIcon("src"+slash+"images"+slash+"home.png");
